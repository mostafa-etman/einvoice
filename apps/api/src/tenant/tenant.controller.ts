...
export class TenantController {
  ...
  async create(
    ...
    return {
      ...
      trialEndsAt: tenant.account.trialEndsAt?.toISOString() ?? null,
  ...
  /** Public-to-authenticated: WhatsApp activation contact (no tenant required). */
  @Get('activation-help')
  activationHelp() {
    return this.points.getSupportContact();
  }
